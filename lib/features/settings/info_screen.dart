      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            const Text('Héctor Martínez Reyes', style: TextStyle(color: Colors.white54)),
            const Text('Ingeniería en Tecnologías de la Información y Negocios Digitales', style: TextStyle(fontSize: 18)),
            const Text('Si lees esto, felicidades, te picho una memela.', style: TextStyle(fontSize: 18)),
          ],
        ),
      ),
    );
